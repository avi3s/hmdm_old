 ...
 * persistence layer of the <code>License Server</code> application.</p>
 *
 * @author isv
 */
public class LicensePersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>LicensePersistenceModule</code> instance. This implementation does nothing.</p>
     */
    public LicensePersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.license.persistence.mapper";
    }
    ...
    protected String getDomainObjectsPackageName() {
        return "com.hmdm.license.persistence.domain";
    }
}
