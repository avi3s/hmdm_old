...
rem set TARGET_DIR=target\opensource
set TARGET_DIR=C:\src\hmdm\opensource\hmdm-server
...
awk !/photo/ plugins\pom.xml | awk !/licensing/ | awk !/contacts/ | awk !/deviceimport/ | awk !/deviceexport/ | awk !/devicereset/ | awk !/deviceinfo/ | awk !/devicelocations/ > %TARGET_DIR%\plugins\pom.xml
...
awk !/photo/ server\pom.xml | awk !/licensing/ | awk !/contacts/ | awk !/deviceimport/ | awk !/deviceexport/ | awk !/deviceinfo/ | awk !/devicereset/ | awk !/devicelocations/ > %TARGET_DIR%\server\pom.xml
...
awk !/photo/ server\build.properties | awk !/licensing/ | awk !/license/ | awk !/deviceimport/ | awk !/deviceexport/ | awk !/deviceinfo/ | awk !/devicereset/ | awk !/devicelocations/ > %TARGET_DIR%\server\build.properties
...
rem cp --parents -v hmdm_install.sh %TARGET_DIR%
