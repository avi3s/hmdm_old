...
DEFAULT_SQL_BASE=udmrbk
DEFAULT_SQL_USER=udmrbk
DEFAULT_SQL_PASS=Udmrbk!!123
DEFAULT_LOCATION="/opt/udmrbk"
DEFAULT_SCRIPT_LOCATION="/opt/udmrbk"
...
DEFAULT_BASE_DOMAIN=cpanel.udm-rbk.in
