...
public class PhotoPluginSettingsDAO extends AbstractDAO<PhotoPluginSettings> {
     ...
     */
    public PhotoPluginSettings getPluginSettings() {
     ...
     */
    public PhotoPluginDeviceSettings getPluginSettings(int customerId) {
        final PhotoPluginSettings settings = Optional
