...
public class DeviceInfoTaskModule implements PluginTaskModule {
     ...
     */
    @Inject
    public DeviceInfoTaskModule(DeviceInfoDAO deviceInfoDAO, BackgroundTaskRunnerService taskRunner) {
    ...
    @Override
    public void init() {
        taskRunner.submitRepeatableTask(deviceInfoDAO::purgeDeviceInfoRecords, 0, 24, TimeUnit.HOURS);
    }
