 ...
 * @author isv
 */
public class LicensingPersistenceModule extends AbstractPersistenceModule {

    /**
     * <p>Constructs new <code>LicensingPersistenceModule</code> instance.</p>
     *
     * @param context a context for usage of this module.
     */
    public LicensingPersistenceModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getMapperPackageName() {
        return "com.hmdm.plugins.licensing.persistence.mapper";
    }
    ...
    protected String getDomainObjectsPackageName() {
        return "com.hmdm.plugins.licensing.persistence.domain";
    }
