...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Licensing</code>\
 * plugin.</p>
 *
 * @author isv
 */
public class LicensingLiquibaseModule extends AbstractLiquibaseModule {

    /**
     * <p>Constructs new <code>LicensingLiquibaseModule</code> instance. This implementation does nothing.</p>
     */
    public LicensingLiquibaseModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getChangeLogResourcePath() {
        String path = this.getClass().getResource("/liquibase/licensing.changelog.xml").getPath();
